    ...
    <div className="grid gap-1">
      <div className="flex gap-1">
        ...
        >
          ...
          {/* Приём — ОДНА заливка, до максимума столбца. Их было две:
              плотная до минимума и светлая до максимума, чтобы показать
              разброс внутри столбца. Владелец прочитал светлую как
              постороннюю тень — «это очень путает», — и он прав: в часовом
              окне разброс был у всех столбцов и в среднем составлял две
              трети высоты, так что кайма перекрывала сам график. Минимум не
              потерян: он приходит с сервера и виден в подсказке при
              наведении (amnezia-vpn-server-lzqx). Разрывы рвут заливку, а не
