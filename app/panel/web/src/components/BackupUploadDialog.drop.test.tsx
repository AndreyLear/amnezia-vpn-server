...
describe("BackupUploadDialog drop", () => {
  ...
  it("uses a brighter hover border on the idle dashed dropzone", () => {
    ...
    const dropzone = screen.getByText("Перетащите файл сюда или выберите на диске").closest('[data-testid="dropzone"]');
  ...
  it("accepts a backup archive dropped on the overlay without closing", () => {
    ...
    const label = screen.getByText("Перетащите файл сюда или выберите на диске").closest('[data-testid="dropzone"]');
