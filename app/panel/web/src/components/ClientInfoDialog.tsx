          ...
          >
            <div className="grid gap-2">
              ...
              <Input
                ...
                disabled={pending}
              />
              {/* Текст обязан называть цену. Прежняя подпись обещала «те же
                  потери вдвое меньше при той же скорости» — замер после
                  amnezia-vpn-server-tv8v это опроверг: скорость падает до
                  заданной, и молчать об этом нельзя
                  (amnezia-vpn-server-ouhb). */}
              <p className="text-sm text-muted-foreground">
                Предел не ускоряет, а придерживает: скорость упадёт до
                заданной, и это его цена. Взамен поток становится ровным —
                на замере повторные передачи упали с двух процентов до сотых
                долей, а вместе с ними ушли задержка и рывки
              </p>
              <p className="text-sm text-muted-foreground">
                Размен выгоден видео и звонкам, которым нужна ровная полоса, а
                не пик. Загрузкам он невыгоден: они просто станут медленнее
              </p>
              <p className="text-sm text-muted-foreground">
